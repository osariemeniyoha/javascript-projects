...
const displayMovement = function(acc, sort = false) {
    ...
    const combinedMovDates = acc.movements.map((mov, i) => ({movement: mov, movementDate: acc.movementsDates.at(i)}))
    ...
    combinedMovDates.forEach(function(obj, i) {
        ...
        `
        // Adding html to the webpage into the movement container
